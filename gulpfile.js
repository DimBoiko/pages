...
function serve () {
	...
	watch('src/svg/**.svg',series(svgSprites)).on('change',sync.reload)
}

exports.svg = svgSprites
exports.clear = clear
exports.start = series(clear,scss,html,js,images,fonts,svgSprites,serve)
exports.build = series(clear,scss,html,js,images,fonts,svgSprites)
